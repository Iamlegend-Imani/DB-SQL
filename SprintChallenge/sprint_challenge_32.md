...
- In the Northwind database, what is the type of relationship between the
  ...
  Employees have a relationship where one employee may only have one territory associated with it (via the Territory ID). But a territory may have many Employees assigned to it. (One to Many)

- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?
  Document Store would be appropriate when you expect a lot of data but are not sure how you categorize it. It would not be appropriate when you have a mature business model, and manageable data sizes.  

- What is "NewSQL", and what is it trying to achieve?

NewSQL is a mix of SQL based and NoSQL style management systems. It wants to provide flexibilty and (horizontally)scalable like NoSQL, but have a higher level of consistency like SQL style DBMS.
